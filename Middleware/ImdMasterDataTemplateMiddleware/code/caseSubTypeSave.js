...
const caseSubTypeSaveMiddleware = (req, res, next) => {
    ...
    try {
        ...
        if(typeof payload.subname != 'string' || payload.subname == ''){ ErrorJson.description.push(`Paratmer <subname> mest be String and Not Empty`);}
...
module.exports = caseSubTypeSaveMiddleware;