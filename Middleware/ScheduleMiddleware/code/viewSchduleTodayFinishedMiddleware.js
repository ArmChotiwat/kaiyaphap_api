...
const view_Schdule_Today_Finished_Middleware = async (req, res, next) => {
    ...
    try {
        ...
        if (!miscController.validateDateTime.validateDate_String(getdate)) { ErrorJson.description.push(`Paratmer <tabledate> must be  String date Fomat`); }
...
module.exports = view_Schdule_Today_Finished_Middleware;