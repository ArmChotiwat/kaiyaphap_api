const search_Patient_ListMiddleware = async (req, res, next) => {
    ...
    try {
        ...
        if (ErrorJson.description.length > 0) { res.status(400).end(); return; }
        else {
...
module.exports = search_Patient_ListMiddleware;