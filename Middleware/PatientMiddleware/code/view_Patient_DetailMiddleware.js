const view_Patient_DetailMiddleware = async (req, res, next) => {
    /**
     ** Query => {
    ...
    try {
        ...
        if (!validate_StringObjectId_NotNull(patient_userid)) { ErrorJson.description.push(`Param <patient_userid> must be String ObjectId`); }
...
module.exports = view_Patient_DetailMiddleware;