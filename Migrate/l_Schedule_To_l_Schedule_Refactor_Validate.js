                            ...
                            if (!findAgent) { throw new Error(`findAgent have error during aggregate`); }
                                ...
                                if (findAgent.length === 1 && findPatient.length === 1) {
                                    const dataTableB = {
                                        ...
                                        schedule_timeFrom_String,
                                        schedule_timeTo_String,

                                        schedule_dateFrom: moment(`${schedule_date_String} ${schedule_timeFrom_String}`, 'YYYY-MM-DD HH:mm').utcOffset("+7:00").format(),
                                        schedule_dateTo: moment(`${schedule_date_String} ${schedule_timeTo_String}`, 'YYYY-MM-DD HH:mm').utcOffset("+7:00").format(),
                                    };
                                    if (
                                        ...
                                        const MAP_DATA_Schedule = {
                                            ...
                                            create_date: dataTableB.schedule_dateFrom,
                                            create_date_string: dataTableB.schedule_dateFrom,
                                            create_time_string: dataTableB.schedule_timeFrom_String,
                                            modify_date: dataTableB.schedule_dateTo,
                                            modify_date_string: dataTableB.schedule_dateTo,
                                            modify_time_string: dataTableB.schedule_timeTo_String,
                                            dateFrom: dataTableB.schedule_dateFrom,
                                            dateFrom_string: dataTableB.schedule_date_String,
                                            timeFrom_string: dataTableB.schedule_timeFrom_String,
                                            dateTo: dataTableB.schedule_dateTo,
                                            dateTo_string: dataTableB.schedule_date_String,
                                            timeTo_string: dataTableB.schedule_timeTo_String,
