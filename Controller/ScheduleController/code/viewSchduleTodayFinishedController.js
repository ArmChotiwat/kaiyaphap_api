const view_Schedule_Todey_Finished_Controller = async (
    data = {
        _storeid: new String(''),
    ...
    if (
        ...
        const name_fn = 'view_Schedule_Todey_Finished_Controller';
...
module.exports = view_Schedule_Todey_Finished_Controller;
