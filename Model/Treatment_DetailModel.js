...
const documentName = 'l_treatment_detail';
const treatmentDetailSchema = new Schema({
...
treatmentDetailSchema.index({ '_ref_productid': 1 }, {});
treatmentDetailSchema.index({ '_ref_productid': 1, '_ref_storeid': 1 }, {});
treatmentDetailSchema.index({ '_ref_productid': 1, '_ref_branchid': 1 }, {});
treatmentDetailSchema.index({ '_ref_productid': 1, '_ref_storeid': 1, '_ref_branchid': 1 }, {});

treatmentDetailSchema.index({ '_ref_courseid': 1 }, {});
treatmentDetailSchema.index({ '_ref_courseid': 1, '_ref_storeid': 1 }, {});
treatmentDetailSchema.index({ '_ref_courseid': 1, '_ref_branchid': 1 }, {});
treatmentDetailSchema.index({ '_ref_courseid': 1, '_ref_storeid': 1, '_ref_branchid': 1 }, {});

treatmentDetailSchema.index({ '_ref_storeid': 1 }, {});
treatmentDetailSchema.index({ '_ref_branchid': 1 }, {});
treatmentDetailSchema.index({ '_ref_storeid': 1, '_ref_branchid': 1 }, {});

treatmentDetailSchema.plugin(updateIfCurrentPlugin, { strategy: "version" });

const treatmentDetailModel = mongooseConn.model(documentName, treatmentDetailSchema);

module.exports = treatmentDetailModel;